            ...
            {activeTab === 2 && (
              <div className="flex flex-col " ref={containerRef}>
                  ...
                  <div className="flex flex-col items-start justify-start h-full col-span-1 w-full order-3 md:order-3 gap-0 md:gap-10">
                    <div className="flex flex-col items-start justify-center gap-4 text-white w-full">
                      ...
                      >
                        ...
                        <li>
                          Aislamiento térmico con fibra de lana mineral de tres
                          ...
                          <ul className="ml-2 lg:ml-6">
                            <li
                              className="relative pl-5 before:absolute before:left-0 before:top-2 before:h-2
                                                        ...
                                                        before:bg-transparent"
                            >
                              Bomba de 2” con motor de 10 HP para el modelo de
                              1,000,000 Btu/hr.
                            </li>
                          </ul>
                        </li>
                    ...
                    <div className="flex flex-col items-start justify-start gap-4 text-white w-full">
                      ...
                      >
                        ...
                        <li>
                          Transferencia de calor eficiente mediante diseño de
                          doble serpentín.
                        </li>
                        <li>Desempeño estable en operación continua.</li>
                        <li>
                          Diseñado para máxima durabilidad, confiabilidad y
                          larga vida útil.
                        </li>
                      </ul>
                    </div>
                ...
                <div className="flex justify-start md:justify-center items-end my-10 overflow-x-auto w-full whitespace-nowrap flex-nowrap">
                  ...
                  <div className="flex flex-col items-center justify-center shrink-0">
                    ...
                    <div className="w-full h-full flex justify-center items-center">
                      <img src={BPCalderaVL.src} alt="" className="w-[530px]" />
                    </div>
                  </div>
                </div>
                <div className="flex flex-col  gap-4 text-white w-full lg:w-[35%] md:w-[35%] mt-10 md:mt-0">
                  ...
                  <div
                    className={`flex flex-col items-center transition-all duration-500 md:mb-0 overflow-hidden  ${
                      openSections.C3_3
                        ? "max-h-96 opacity-1 mb-4"
                        : "max-h-0 opacity-1"
                ...
                <div className="flex flex-col md:grid md:grid-cols-4 justify-center items-center w-full">
                  ...
                  >
                    ...
                    <div className="text-white font-normal w-full flex flex-col gap-4 justify-between h-full">
                      ...
                      <div
                        className={`transition-all duration-500 overflow-hidden text-sm lg:text-base ml-2 lg:ml-6  ${
                          openSections.C2_2
                            ? "max-h-96 opacity-1 mb-4"
                            : "max-h-0 opacity-0"
                        } md:max-h-full md:opacity-100 md:block md:mb-0`}
                      >
                        <ul className="list-disc list-inside">
                          ...
                          <li>Bombas:</li>
                          <li className="pl-5">
                            Bomba de 3” con motor de 15 HP para el modelo de
                            2,400,000 Btu/hr.
                          </li>
                        </ul>
                      </div>

                ...
                <div className="flex flex-col md:grid md:grid-cols-4 justify-center items-center">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start justify-start gap-4 text-white">
                      ...
                      >
                        <li>
                          Reemplazo sencillo de bolsas mediante bastidores de
                          cambio rápido.
                        </li>
                        <li>
                          Puertas de acceso y registros de inspección para
                          facilitar el mantenimiento.
                        </li>
                        <li>
                          Polvo de precubrimiento para bolsas aplicado en
                          fábrica, sin tiempos de espera para la puesta en
                          marcha.
                        </li>
                        <li>
                          99.99% de eficiencia de filtración y limpieza
                          energéticamente eficiente desde el arranque.
                        </li>
                        <li>
                          Sistemas integrados y autónomos para plantas
                        ...
                        <li>
                          Hasta 260 °C en picos de temperatura con bolsas de
                          poliimida P84.
                        </li>
                      </ul>
                    </div>
                  ...
                  >
                    <div className="flex flex-col w-full items-start justify-center gap-4 text-white">
                      ...
                      >
                        ...
                        <li>
                          Ventilador de extracción con aspas curvadas para una
                          operación silenciosa y eficiente.
                        </li>
                        <li>
                          Boquillas supersónicas impresas en 3D con aleación de
                          carbono para la limpieza por aire pulsante.
                        </li>
                        <li>
                          Retorno uniforme de finos al mezclador de tambor.
                        </li>
                      </ul>
                    </div>
          ...
          <div className="flex justify-start md:justify-center items-end my-10 overflow-x-auto w-full whitespace-nowrap flex-nowrap">
            ...
            <div className="flex flex-col items-center justify-center shrink-0 min-w-[744px]">
              ...
              <div className="h-[350px] w-[744px]">
                <img src={BpBagHousesVL.src} alt="" className="h-full w-auto" />
              </div>
            </div>
          </div>
        </div>
